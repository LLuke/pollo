 ...
 * @author Bruno Dumon
 */
public class DisplayContentModelAction extends AbstractAction implements SelectionListener
{
	protected XmlEditor xmlEditor;
	protected ContentModelDialog contentModelDialog;

	public DisplayContentModelAction(XmlEditor xmlEditor)
	{
		super("Show content model...");
